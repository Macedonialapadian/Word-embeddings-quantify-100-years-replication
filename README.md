...
- **Extended Figure:** `output/extend_figure/`
  The 'Data' folder under 'extend_figure' is empty, it should be placed with 'newsroom_test.jsonl' files download from this [link](https://drive.google.com/drive/folders/1OpWGtNB-IJTg4nE6U8yRb41mKaPVk-oP?usp=drive_link), and it is originally come from this [project](https://lil.nlp.cornell.edu/newsroom/index.html)
